...
type BankProviderMode = { provider: "mock" | "enablebanking"; environment: "demo" | "sandbox" | "production"; realBankDataEnabled: boolean };
...
function BankConnectionForm({ busy, onClose, onConnect }: { busy: boolean; onClose: () => void; onConnect: (country: string, institutionId: string) => Promise<void> }) {
  ...
  const banner = mode?.environment === "production"
    ...
    : mode?.environment === "sandbox"
      ? { title: "Sandbox real do prestador", copy: "O fluxo usa a API sandbox da Enable Banking e apenas instituições de teste, incluindo o Mock ASPSP." }
